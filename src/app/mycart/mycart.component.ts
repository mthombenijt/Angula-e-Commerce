...
export class MycartComponent implements OnInit {
  ...
  constructor(private productService:ProductService,private sharedService:SharedService,private fb: FormBuilder,private authService:AuthenticationService,private orderService:OrderService) 
  {
...
countProduct(count: number){
  this.sharedService.updateCartCount(count);
}
